...
const service_content: DataType = {
  ...
  title: (
    <>
      A Curious <br /> Mind Passionate About Learning
    </>
  ),
  sm_info: (
    <>
      Driven by curiosity, I immerse myself in <br />
      learning new technologies thinking critically.
    </>
  ),
  btn_text: (
    <>
  ...
  service_data: [
    {
      ...
      sm_des: (
        <>
          ...
          appealing designs with advanced styling techniaues.
        </>
      ),
    ...
    },
    {
      ...
      sm_des: (
        <>
          Utilizing Git for version control, Linux <br />
          for system operations, AWS for cloud services, and Node.js for
          efficient back-end services.
        </>
      ),
