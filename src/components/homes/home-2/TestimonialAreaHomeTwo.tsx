...
const TestimonialAreaHomeTwo = () => {
  ...
  useEffect(() => {
    ...
    document
      .querySelectorAll('.tp-3d-slide-arrow-right, .tp-3d-slide-arrow-left')
      .forEach((arrow) => {
        ;(arrow as HTMLDivElement).addEventListener(
          'click',
          handleArrowClickWrapper as any
        )
      })
    ...
    return () => {
      ...
      document
        .querySelectorAll('.tp-3d-slide-arrow-right, .tp-3d-slide-arrow-left')
        .forEach((arrow) => {
          ;(arrow as HTMLDivElement).removeEventListener(
            'click',
            handleArrowClickWrapper as any
          )
        })
